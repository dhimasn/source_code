...
{
	if(confirm('Anda yakin ingin memnghapus File?'))	{
...
function multiple_file_uploader(configuration_settings)
{
	...
	multiple_file_uploader.prototype.read_file = function(e) {
		if(e.target.files) {
			...
			alert('Maaf, file yang Anda unggah tidak dapat dibaca!');
		}
	}
	...
	}else { alert('Maaf, ERROR Menggunggah File!'); }
